...
| `google-apis/CONNECTOR.md` | Run PageSpeed Insights on one public URL, translate text through Google Cloud Translation, and synthesize speech through Cloud Text-to-Speech |
