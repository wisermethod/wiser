...
| `pages` | Account / Cloudflare Pages / Read for list and get. Edit for `create_project`, `add_domain`, `remove_domain`, `delete_project`, and `deploy`. A Read-only token returns 403 on those five |
