...
const cases = {
  get_model: {"input":{"namespace":"example","repo":"example-model"},"required":["namespace","repo"],"expected":{"namespace":"example","repo":"example-model"},"result":{"id":"example/example-model"}},
  list_datasets: {"input":{"search":"example","author":"example","limit":1,"cursor":"example"},"required":[],"expected":{"search":"example","author":"example","limit":1,"cursor":"example"},"result":{"datasets":[{"id":"example/example-dataset"}]}},
};
