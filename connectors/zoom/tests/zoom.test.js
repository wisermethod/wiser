...
const cases = {
  list: {"input":{"user_id":"me","type":"example","from":"example","to":"example","page_size":1,"page_number":1,"next_page_token":"example"},"required":["user_id"],"expected":{"user_id":"me","type":"example","from":"example","to":"example","page_size":1,"page_number":1,"next_page_token":"example"},"result":{"meetings":[{"id":"meeting-example"}]}},
  get: {"input":{"meeting_id":"example","occurrence_id":"example"},"required":["meeting_id"],"expected":{"meeting_id":"example","occurrence_id":"example"},"result":{"id":"meeting-example"}},
};
