...
const cases = {
  get_contact: {"input":{"contact_id":"example","archived":false,"properties":["example"],"associations":["example"]},"required":["contact_id"],"expected":{"contactId":"example","archived":false,"properties":["example"],"associations":["example"]},"result":{"id":"contact-example"}},
  search_contacts: {"input":{"query":"example","limit":1,"after":"example","properties":["example"],"filter_groups":[{"filters":[]}]},"required":[],"expected":{"query":"example","limit":1,"after":"example","properties":["example"],"filterGroups":[{"filters":[]}]},"result":{"results":[{"id":"contact-example"}]}},
};
