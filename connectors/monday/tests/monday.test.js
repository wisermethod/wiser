...
const cases = {
  list: {"input":{"ids":[1],"page":1,"limit":1,"workspace_ids":[1]},"required":[],"expected":{"ids":[1],"page":1,"limit":1,"workspace_ids":[1]},"result":{"boards":[{"id":"board-example","name":"Example"}]}},
  list_items: {"input":{"board_id":1,"limit":1,"cursor":"example","group_id":"example"},"required":["board_id"],"expected":{"board_id":1,"limit":1,"cursor":"example","group_id":"example"},"result":{"items":[{"id":"item-example","name":"Example"}]}},
};
