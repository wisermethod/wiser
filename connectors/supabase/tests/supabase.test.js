...
const cases = {
  list: {"input":{},"required":[],"expected":{},"result":{"projects":[{"id":"project-example","name":"Example"}]}},
  get: {"input":{"ref":"example"},"required":["ref"],"expected":{"ref":"example"},"result":{"id":"project-example","name":"Example"}},
};
