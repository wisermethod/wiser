...
const cases = {
  get: {"input":{"file_key":"example"},"required":["file_key"],"expected":{"file_key":"example"},"result":{"name":"Example"}},
  list: {"input":{"project_id":"example","branch_data":false},"required":["project_id"],"expected":{"project_id":"example","branch_data":false},"result":{"files":[{"key":"file-example","name":"Example"}]}},
};
