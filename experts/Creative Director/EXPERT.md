...
- A verdict reads ship-ready, needs work with its top three named, or significant revision; a direction cites specific references rather than descriptors; a media direction settled references or the frame standard before the first billed call.
