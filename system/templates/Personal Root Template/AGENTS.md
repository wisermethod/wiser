...
Not onboarded. `skills/Onboard Root/` fills this root on its personal path and rewrites these lines at close. Its Step 5 says what each state means and what a key that is not complete refuses.
