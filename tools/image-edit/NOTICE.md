# Third-party notice: image-edit

This tool installs the 30 packages below on the machine that calls it, into this tool's own directory, the first time it is used. **This repository redistributes none of them.**
