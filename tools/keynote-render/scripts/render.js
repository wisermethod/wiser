...
function flag(name) {
  ...
  if (argv.indexOf(name, index + 1) !== -1) {
    fail(`Error: ${name} was given more than once and takes one value. Run "node scripts/render.js help" for usage.`);
  }
...
if (command !== 'check') writeConsent(HERE, 'keynote-render');
