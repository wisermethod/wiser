# Third-party notice: Browser Control

This tool installs the 3 packages below on the machine that calls it, into this tool's own directory, the first time it is used. **This repository redistributes none of them.**
