...
// -- check ---------------------------------------------------------
// Reports what is present and installs nothing, so a machine can be prepared
// before the first real run. Chromium is proved by a trial launch via the
// shared browser-runtime (not a path on disk alone).
