...
const DEFAULT_SLUGS = {
  ...
  'google.search-console.inspect': 'FAKE_GOOGLE_SEARCH_CONSOLE_INSPECT',
  'google.search-console.get_sitemap': 'FAKE_GOOGLE_SEARCH_CONSOLE_GET_SITEMAP',
  'bing.webmaster.list_sites': 'FAKE_BING_WEBMASTER_LIST_SITES',
  'bing.webmaster.search_performance': 'FAKE_BING_WEBMASTER_SEARCH_PERFORMANCE',
  'bing.webmaster.query_performance': 'FAKE_BING_WEBMASTER_QUERY_PERFORMANCE',
  'bing.webmaster.page_performance': 'FAKE_BING_WEBMASTER_PAGE_PERFORMANCE',
  'bing.webmaster.crawl_diagnostics': 'FAKE_BING_WEBMASTER_CRAWL_DIAGNOSTICS',
  'bing.webmaster.inspect_url': 'FAKE_BING_WEBMASTER_INSPECT_URL',
  'bing.webmaster.feeds': 'FAKE_BING_WEBMASTER_GET_FEEDS',
  'bing.webmaster.inbound_links': 'FAKE_BING_WEBMASTER_INBOUND_LINKS',
  'bing.webmaster.research_keywords': 'FAKE_BING_WEBMASTER_RESEARCH_KEYWORDS',
...
const DEFAULT_RESULTS = {
  ...
  FAKE_BING_WEBMASTER_CRAWL_DIAGNOSTICS: [{ IssueType: 'BlockedByRobotsTxt', Urls: 1 }],
  FAKE_BING_WEBMASTER_INSPECT_URL: { Url: 'https://example.com/page', IndexStatus: 'Indexed' },
  FAKE_BING_WEBMASTER_GET_FEEDS: [{ Url: 'https://example.com/sitemap.xml', Status: 'Success' }],
  FAKE_BING_WEBMASTER_INBOUND_LINKS: [{ SourceUrl: 'https://referrer.example/', AnchorText: 'example' }],
  FAKE_BING_WEBMASTER_RESEARCH_KEYWORDS: [{ Query: 'example', Impressions: 100, BroadImpressions: 200 }],
      ...
      result: {
        ...
        data: {
          ...
          tasks: [{
            ...
            result_count: 2,
            result: [
              { location_code: 2840, location_name: 'United States', country_iso_code: 'US', language_code: 'en' },
              { location_code: 2826, location_name: 'United Kingdom', country_iso_code: 'GB', language_code: 'en' },
            ],
          }],
        },
        headers: {},
      ...
      result: {
        ...
        data: {
          ...
          tasks: [{
            ...
            cost: 0.012,
            result_count: 1,
            result: [{ items: [{ keyword: 'example', rank_group: 1 }] }],
          }],
        },
        headers: {},
      },
