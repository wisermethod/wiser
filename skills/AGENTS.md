...
| `Onboard Root/SKILL.md` | Create a user root from its template and onboard it, on a short path for one person's own root and a full path for every other type |
