...
Three parameters describe one frame. The defaults reproduce one house standard and carry no authority beyond it; a caller with their own standard states it in `<frame_standard>` and gets it.
