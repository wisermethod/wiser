...
- **Voice absent.** An unbound `voice`, or one still a stub or carrying the `[Not available: ...]` label `skills/Onboard Root/` writes over a stub's prompt lines, is `skills/Build Voice/`'s work, not a voice to improvise; a speech drafted against no voice cannot meet its own voice check. Stop and route.
