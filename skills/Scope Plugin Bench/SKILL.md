...
- Coverage is not enough, by the question in step 2, and further research is unavailable: that is the same stop. Do not call that coverage enough, and do not invent a bench.
